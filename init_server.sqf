...
call compile preprocessFileLineNumbers "PopoFunctions\server\server_functions.sqf";
...
0 spawn {
	...
	if (!isNil "MHQ_1") then {
		...
		if (JIG_MHQ_enabled) then {
			...
			_nul = [MHQ_1,/* 14400, 0.01, */{_this setVariable["persistent",true]; _VarName = "MHQ_1"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName];/* [_this] call BMRINS_fnc_customMHQ; */INS_MHQ_killed = "MHQ_1"; publicVariable "INS_MHQ_killed";}] /*execVM "vehrespawn.sqf"*/;
			_nul = [{_this setVariable["persistent",true]; _VarName = "MHQ_1"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName]; /*[_this] call BMRINS_fnc_customMHQ; */INS_MHQ_killed = "MHQ_1"; publicVariable "INS_MHQ_killed";}];
		};
	};
	if (!isNil "MHQ_2") then {
		...
		if (JIG_MHQ_enabled) then {
			...
			_nul = [MHQ_2, /*14400, 0.01, */{_this setVariable["persistent",true]; _VarName = "MHQ_2"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName];/* [_this] call BMRINS_fnc_customMHQ;*/ INS_MHQ_killed = "MHQ_2"; publicVariable "INS_MHQ_killed";}] /*execVM "vehrespawn.sqf"*/;
			_nul = [{_this setVariable["persistent",true]; _VarName = "MHQ_2"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName];/* [_this] call BMRINS_fnc_customMHQ;*/ INS_MHQ_killed = "MHQ_2"; publicVariable "INS_MHQ_killed";}];
		};
	};
	if (!isNil "MHQ_3") then {
		...
		if (JIG_MHQ_enabled) then {
			...
			_nul = [MHQ_3, /*14400, 0.01,*/ {_this setVariable["persistent",true]; _VarName = "MHQ_3"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName]; /*[_this] call paint_heli_fnc;*/ [_this] call anti_collision; [_this] spawn BMR_resetDamage; INS_MHQ_killed = "MHQ_3"; publicVariable "INS_MHQ_killed";}] /*execVM "vehrespawn.sqf"*/;
			_nul = [{_this setVariable["persistent",true]; _VarName = "MHQ_3"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName]; /*[_this] call paint_heli_fnc; [_this] call anti_collision; [_this] spawn BMR_resetDamage;*/ INS_MHQ_killed = "MHQ_3"; publicVariable "INS_MHQ_killed";}];
		};
	};
	if (!isNil "Opfor_MHQ") then {
		...
		if (JIG_MHQ_enabled) then {
			...
			_nul = [Opfor_MHQ, 14400, 0.01, {_this setVariable["persistent",true]; _VarName = "Opfor_MHQ"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName]; INS_MHQ_killed = "Opfor_MHQ"; publicVariable "INS_MHQ_killed";}] execVM "vehrespawn.sqf";
			_nul = [{_this setVariable["persistent",true]; _VarName = "Opfor_MHQ"; _this setVehicleVarName _VarName; _this Call Compile Format ["%1=_this; publicVariable '%1'",_VarName]; INS_MHQ_killed = "Opfor_MHQ"; publicVariable "INS_MHQ_killed";}];
		};
	};
};
...
if (Airfield_opt) then
{
	...
	if (toLowerANSI (worldName) isEqualTo "altis") then {
	...
	private _vanillaDefault = {
		...
		_nul = [_fw1, 120, 60, {[_this] call anti_collision; [_this, dynPylons1] call INS_replace_pylons}] execVM "vehrespawn.sqf";
	};
	...
	if (_mod) then {
		...
		if (!isNil "INSdefLoadOutBlu") then {
			...
			_nul = [_fw1, 120, 60, {[_this] call anti_collision; [_this, INSdefLoadOutBlu] call INS_replace_pylons}] execVM "vehrespawn.sqf";
		} else {
			_nul = [_fw1, 120, 60, {[_this] call anti_collision}] execVM "vehrespawn.sqf";
		};
	} else {
	...
	0 spawn {
		if (!(getMarkerColor "AircraftMaintenance" isEqualTo "") || (markerAlpha "AircraftMaintenance" isEqualTo 1)) then {
			...
			_uavServiceTrig setTriggerTimeout [5, 5, 5, true];
...
private _anchorPos = getPosATL INS_E_HQ;
