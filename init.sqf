...
// Popo Functions
call compile preprocessFileLineNumbers "PopoFunctions\common\common_functions.sqf";
//call compile preprocessFileLineNumbers "PopoFunctions\server\server_functions.sqf";
// Init attach relative to vehicle
[MHQ_1] call Popo_Attach_Logistic_Vehicle_Mhq_1_fnc;
[MHQ_2] call Popo_Attach_Logistic_Vehicle_Mhq_2_fnc;
[RPIMA_pickup_rearm_repair] call Popo_Attach_Logistic_Vehicle_pickup_rearm_repair_fnc;
...
// Common Scripts
//execVM "scripts\VehAug\VehicleAugmentation.sqf";
execVM "Objectives\shk_taskmaster.sqf";
execVM "PopoFunctions\Popo_init.sqf";
if ((JigHeliExtraction isEqualTo 1) && {!IamHC}) then {execVM "JIG_EX\extraction_init.sqf"};
if (CiviMobiles > 0) then {[CiviMobiles, 400, 1500] execVM "scripts\MAD_traffic.sqf"};
...
//[west, "HQ"] sideChat "après serveur";
// Init Player
if (hasInterface) then
{
	0 spawn {
		...
		//[west, "HQ"] sideChat "chargement test";
...
//[west, "HQ"] sideChat "après init player";
/*
