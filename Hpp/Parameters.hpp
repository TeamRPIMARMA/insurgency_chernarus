...
*/
	...
	texts[]={
	"RHS AFRF and Spetsnaz - Requirements :: @RHSAFRF",
	"AFRICAN MILITIA - Requirements :: Drongo's simple factions",
	...
	class InfAirReinPb//15
	{
	title = "		Enemy Infantry Air reinforcement Probability";
	values[]={1,25,50,75,100};
	texts[]={"0 % chance Infantry Air reinforcement + Rewards disabled","25 % chance","50 % chance","75 % chance","100 % chance"};
	default = 100;
	};
	...
	values[]={0,0.5,1,2,3,4,5,6,8,10,12,14,16,18,20,30,60};
	texts[]={"Disabled","30 seconds","1 minute","2 minutes","3 minutes","4 minutes","5 minutes","6 minutes","8 minutes","10 minutes","12 minutes","14 minutes","16 minutes","18 minutes","20 minutes","30 minutes","60 minutes"};
	default = 5;
	};
	...
	{
	title = "		Enable TL Group Heli Extraction?";
	values[]={0,1};
	texts[]={"No","Yes"};
	default = 1;
	};
/*
	class Popo_slot_paradrop//35
	{
	title = "		active ou désactive spécialité paradrop";
	values[]={0,1};
	texts[]={"Désactivé","Actvivé"};
	default = 0;
	};
*/
	...
	texts[]={
	"No",
	"Yes (Orange Hand and GL smoke grenades. A3 Nato Pilot helmet, full faced Viper helmets, Contact DLC gas masks and or Gas Masks from @hiddenidentitypack, @nato_russian_sf_weapons, @AVON FM12 and @FFAA mods"};
	default = 0;
	};
	class limitPOV//36
	{
	...
	{
	title = "		Save on player killed/Enable Save/Restore full loadout on respawn?";
	values[]={0,1,2};
	texts[]={"On Player Killed","No, respawn with inventory you had at death (Reload Magazine to Save Kit)","Yes"};
	default = 0;
	};
	...
	texts[]={"1 intel : 2 zones","1 intel : 3 zones","1 intel : 4 zones","1 intel : 5 zones","1 intel : 6 zones","1 intel : 7 zones","1 intel : 8 zones","1 intel : 9 zones"};
	default = 6;
	};
