...
_availableMagazines = [
	...
	"SmokeShellGreen",
	"SmokeShellBlue",
	"SmokeShellOrange",			//Poison Gas Grenade
	"SmokeShellPurple",
	"SmokeShellRed",
	"SmokeShell",
...
// Vanilla Backpacks
	...
	"R3F_sac_lourd_SNOW",
	"R3F_sac_moyen_CE",
	"R3F_sac_moyen_medic_CE",
	"R3F_sac_moyen_medic_noir",
	"R3F_sac_moyen_medic_TAN",
	"R3F_sac_moyen_medic_SNOW",
	"R3F_sac_moyen_noir",
	"R3F_sac_moyen_TAN",
	"R3F_sac_moyen_SNOW",
	"R3F_sac_radio_TFR_Lourd_CE",
	"R3F_sac_radio_TFR_Lourd_TAN",
	"R3F_sac_radio_TFR_Lourd_SNOW",
	"R3F_sac_vie_OD",
	"R3F_sac_vie_TAN",
	"R3F_sac_vie_SNOW",
...
// Vanilla items
	...
	*/
	...
	"R3F_uniform_pilot",
	"R3F_uniform_Ghillie",
	"R3F_uniform_GhillieFULL",
	"R3F_uniform_GhillieFULL_DA",
	"R3F_uniform_GhillieFULL_MFO",
	"R3F_uniform_GhillieFULL_SNOW",
	"R3F_uniform_Ghillie_DA",
	"R3F_uniform_Ghillie_MFO",
	"R3F_uniform_Ghillie_SNOW",
	"R3F_uniform_f1",
	"R3F_uniform_apso",
	"R3F_uniform_CQB",
	"R3F_uniform_f1_DA",
	...
	"R3F_uniform_urr_medic_MFO",
	"R3F_uniform_urr_medic_SNOW",
	"R3F_uniform_urr_MFO",
	"R3F_uniform_urr_SNOW",
	"R3F_uniform_f1_medic",
	"R3F_uniform_CQB_medic",
	"R3F_uniform_f1_medic_DA",
	"R3F_uniform_f1_medic_SNOW",
	"R3F_uniform_off",
	"R3F_uniform_off_DA",
	"R3F_uniform_f1_SNOW",
	...
	*/
	...
	"amf_felin",
	"amf_felin_mount",
	"AMF_FELIN_MOUNT_EARPROT_BLK",
	"AMF_FELIN_MOUNT_EARPROT_OD",
	"AMF_FELIN_MOUNT_EARPROT_TAN",
	"AMF_FELIN_EARPROT_NLK",
	"AMF_FELIN_EARPROT_OD",
	"AMF_FELIN_EARPROT_TAN",
	"amf_felin_cover",
	"AMF_FELIN_COVER_EARPROT_BLK",
	"AMF_FELIN_COVER_EARPROT_OD",
	"AMF_FELIN_COVER_EARPROT_TAN",
	"amf_felin_cover_tan",
	"AMF_FELIN_COVER_TAN_EARPROT_BLK",
	"AMF_FELIN_COVER_TAN_EARPROT_OD",
	"AMF_FELIN_COVER_TAN_EARPROT_TAN",
	"AMF_LA100",
	"AMF_TC3000",
	...
	"AMF_TC3000_tan",
	"AMF_TC3000_tan_earprot_blk_f",
	"AMF_TC3000_tan_earprot_od_f",
	"AMF_TC3000_tan_earprot_tan_f",
	"AMF_TC800",
	"AMF_TC800_EARPROT_BLK",
	"AMF_TC800_EARPROT_OD",
	"AMF_TC800_EARPROT_TAN",
	"AMF_TC800_GRN",
	"AMF_TC800_GRN_EARPROT_BLK",
	"AMF_TC800_GRN_EARPROT_OD",
	"AMF_TC800_GRN_EARPROT_TAN",
	"AMF_TC800_TAN",
	"AMF_TC800_TAN_EARPROT_BLK",
	"AMF_TC800_TAN_EARPROT_OD",
	"AMF_TC800_TAN_EARPROT_TAN",
	"AMF_TS3000_01_cover",
	"AMF_TS3000_01_da_cover",
	/*
	"R3F_casque_felin_SNOW",
	"R3F_casqueFS_MFO",
	"R3F_casqueFS_noir",
	"R3F_casqueFS_olive",
	"R3F_casqueFS_tan",
...
*/
	...
	*/
	...
	"amf_smb_tl_grn",
	"amf_smb_tl_famas",
	"amf_smb_tl_famas_grn",
	"amf_smb_tlb",
	"amf_smb_tlb_grn",
	"amf_smb_tlb_famas",
	"amf_smb_tlb_famas_grn",
	"amf_smb_in",
	"amf_smb_in_grn",
	"amf_smb_in_famas",
	"amf_smb_in_famas_grn",
	"amf_smb_inb",
	"amf_smb_inb_grn",
	"amf_smb_inb_famas",
	"amf_smb_inb_famas_grn",
	"amf_smb_gr_grn",
	"amf_smb_gr",
	"amf_smb_gr_famas",
	"amf_smb_gr_famas_grn",
	"amf_smb_grb",
	"amf_smb_grb_grn",
	"amf_smb_grb_famas",
	"amf_smb_grb_famas_grn",
	"amf_smb_me",
	"amf_smb_me_grn",
	"amf_smb_me_famas",
	"amf_smb_me_famas_grn",
	"amf_smb_meb",
	"amf_smb_meb_grn",
	"amf_smb_meb_famas_grn",
	"amf_smb_meb_famas",
	"amf_smb_tp_frf2",
	"amf_smb_tp_frf2_grn",
	"amf_smb_tp_hk417",
	"amf_smb_tp_hk417_grn",
	"amf_smb_tp_scarh",
	"amf_smb_tp_scarh_grn"
	*/
