...
// RHS AFRF VERSION TEAM 1er-RPIMA
if (_opposingArmies isEqualTo 1) then {
	INS_Op4_side = EAST;
	INS_men_list = ["rhs_vmf_emr_junior_sergeant","rhs_vmf_emr_machinegunner","rhs_msv_emr_arifleman","rhs_vmf_emr_RShG2","rhs_vmf_emr_LAT","rhs_vmf_emr_strelok_rpg_assist","rhs_vmf_emr_grenadier_rpg","rhs_vmf_emr_grenadier","rhs_vmf_emr_medic","rhs_vmf_emr_engineer","rhs_vmf_emr_marksman","rhs_vmf_emr_aa"];// Armed soldiers
	INS_Op4_medic = "rhs_vmf_emr_medic";// One Medic
	INS_Op4_Eng = "rhs_vmf_emr_engineer";// One Engineer
	INS_Op4_pilot = ["rhs_pilot_combat_heli","rhs_pilot"];// Pilots
	INS_Op4_Veh_Light = ["rhs_btr80_msv","rhs_btr80a_msv","rhs_kamaz5350_msv","rhs_kamaz5350_open_msv","RHS_Ural_MSV_01","RHS_Ural_Open_MSV_01","RHS_Ural_Zu23_MSV_01","rhs_tigr_sts_msv"];// Armed Wheeled Vehicles
	INS_Op4_Veh_Tracked = ["rhs_bmd4ma_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmp2d_vdv","rhs_bmp3_late_msv","rhs_t72bd_tv","rhs_t72be_tv","rhs_t80uk","rhs_t90sab_tv"];// Armed Tracked Vehicles
	INS_Op4_Veh_Support = ["RHS_Ural_Zu23_MSV_01","RHS_BM21_MSV_01","RHS_Ural_Ammo_MSV_01","RHS_BM21_MSV_01"];// Wheeled Support Vehicles
	INS_Op4_Veh_AA = ["rhs_zsu234_aa"];// Anti Air Vehicles
	INS_Op4_stat_weps = ["rhs_Igla_AA_pod_vdv","rhs_KORD_high_VDV","RHS_ZU23_VDV","rhs_2b14_82mm_vdv","rhs_D30_at_vdv","rhs_D30_vdv"];// Static Weapons
	INS_Op4_fixedWing = ["RHS_TU95MS_vvs_old","RHS_Su25SM_KH29_vvsc","rhs_mig29s_vvsc","rhs_mig29sm_vvsc","RHS_T50_vvs_blueonblue","RHS_T50_vvs_generic_ext"];//"RHS_Su25SM_KH29_vvsc"
	INS_Op4_helis = ["RHS_Mi8MTV3_heavy_vdv","RHS_Ka52_vvsc","RHS_Mi24V_vdv"];//,"RHS_Mi8AMTSh_UPK23_vvsc"
	INS_civlist = ["C_Man_1_enoch_F","C_Man_2_enoch_F","C_Man_3_enoch_F","C_Man_4_enoch_F","C_Man_5_enoch_F","C_Man_6_enoch_F","C_Farmer_01_enoch_F","C_Man_Paramedic_01_F","C_man_hunter_1_F","C_Man_smart_casual_2_F","C_Man_formal_3_F","C_Journalist_01_War_F","C_man_p_fugitive_F","C_man_p_beggar_F","C_Man_UtilityWorker_01_F","C_Man_Fisherman_01_F","C_Man_ConstructionWorker_01_Vrana_F","C_Man_ConstructionWorker_01_Blue_F"];// Civilian Units
	INS_civ_Veh_Car = ["RHS_Ural_Civ_03","C_SUV_01_F","C_Van_01_transport_F","C_Van_02_transport_F","C_Offroad_01_covered_F"];// Civilian Cars
	INS_civ_Veh_Utl = ["C_Tractor_01_F","C_Offroad_01_repair_F","C_Van_01_fuel_F","C_Van_02_medevac_F"];// Civilian Utility Vehicles
};

// AAF
if (_opposingArmies in [2,3]) then {
	INS_Op4_side = RESISTANCE;
	INS_men_list = ["DSF_AFMIL_Marksman","DSF_AFMIL_AASoldier","DSF_AFMIL_RPG7Soldier","DSF_AFMIL_ATSoldier","DSF_AFMIL_AutomaticRifleman","DSF_AFMIL_TeamLeader","DSF_AFMIL_SquadLeader","DSF_AFMIL_Explosives","DSF_AFMIL_Rifleman","DSF_AFMIL_Rifleman_Lite","DSF_AFMIL_Grenadier","DSF_AFMIL_RPG7Grenadier","DSF_AFMIL_Medic","DSF_AFMIL_MachineGunner","DSF_AFMIL_Officer","DSF_AFMIL_Repair"];//"I_soldier_F","I_Soldier_lite_F","I_soldier_AT_F","I_soldier_GL_F","I_soldier_LAT_F","I_soldier_exp_F","I_soldier_F","I_soldier_AR_F","I_soldier_repair_F","I_soldier_LAT_F","I_soldier_AR_F","I_soldier_M_F","I_soldier_AT_F","I_soldier_AA_F","I_soldier_AAA_F","I_soldier_F","I_soldier_TL_F","I_medic_F","I_soldier_GL_F","I_soldier_F","I_Soldier_LAT2_F"
	INS_Op4_medic = "DSF_AFMIL_Medic";
	INS_Op4_Eng = "DSF_AFMIL_Repair";
	INS_Op4_pilot = ["DSF_AFMIL_Crewman"];
	INS_Op4_Veh_Light = ["I_C_Offroad_02_AT_F","I_C_Offroad_02_LMG_F","C_Truck_02_covered_F"];
	INS_Op4_Veh_Tracked = ["ARM_I_LT_01_cannon_F","ARM_I_LT_01_AT_F","yo_pandur_guerilla_02","yo_pandur_guerilla_03"];
	INS_Op4_Veh_Support = ["I_G_Van_01_fuel_F","I_G_Offroad_01_repair_F","I_G_Van_02_vehicle_F"];
	INS_Op4_Veh_AA = ["ARM_I_LT_01_AA_F","ARM_I_LT_01_scout_F"];
	INS_Op4_stat_weps = ["I_GMG_01_high_F","I_G_HMG_02_high_F","I_Mortar_01_F","I_static_AT_F"];
	INS_civlist = ["DSF_CIV_Man","DSF_CIV_ManRobes","C_man_p_beggar_F","C_man_1","C_man_polo_1_F","C_man_polo_2_F","C_man_polo_3_F","C_man_polo_4_F","C_man_polo_5_F","C_man_polo_6_F","C_man_shorts_1_F","C_man_1_1_F","C_man_1_2_F","C_man_1_3_F","C_man_p_fugitive_F","C_man_p_shorts_1_F","C_man_hunter_1_F","C_man_shorts_2_F","C_man_shorts_3_F","C_man_shorts_4_F","C_Man_casual_1_F_afro","C_Man_casual_2_F_afro","C_Man_casual_3_F_afro","C_man_sport_1_F_afro","C_man_sport_2_F_afro","C_man_sport_3_F_afro","C_Man_casual_4_F_afro","C_Man_casual_5_F_afro","C_Man_casual_6_F_afro","C_man_polo_1_F_afro","C_man_polo_2_F_afro","C_man_polo_3_F_afro","C_man_polo_4_F_afro","C_man_polo_5_F_afro","C_man_polo_6_F_afro","C_man_p_fugitive_F_afro","C_man_p_shorts_1_F_afro","C_man_shorts_2_F_afro","C_man_shorts_3_F_afro","C_man_shorts_4_F_afro","C_Man_1_enoch_F","C_Man_2_enoch_F","C_Man_3_enoch_F","C_Man_4_enoch_F","C_Man_5_enoch_F","C_Man_6_enoch_F","C_Farmer_01_enoch_F",
"C_Man_casual_3_F_tanoan","C_Journalist_01_War_F","C_journalist_F","C_Nikos","C_man_sport_3_F_tanoan","C_Man_UAV_06_medical_F","C_Man_ConstructionWorker_01_Black_F","C_scientist_F","C_Man_Paramedic_01_F","C_Orestes","C_Man_ConstructionWorker_01_Red_F","C_Man_UtilityWorker_01_F","C_Man_ConstructionWorker_01_Blue_F","C_Nikos_aged","C_Man_Fisherman_01_F","C_Man_casual_4_F_tanoan","C_scientist_02_informal_F","C_scientist_01_formal_F","C_scientist_02_informal_F","C_IDAP_Man_AidWorker_02_F"];// A3 Civilians
	INS_civ_Veh_Car = ["C_Offroad_01_F","C_Offroad_02_unarmed_F","C_Truck_02_covered_F","C_Quadbike_01_F"];
	INS_civ_Veh_Utl = ["C_Offroad_01_repair_F","C_Van_01_fuel_F","C_IDAP_Van_02_medevac_F","C_Truck_02_fuel_F","C_Truck_02_box_F","C_IDAP_Van_02_vehicle_F","C_IDAP_Truck_02_water_F","C_IDAP_Truck_02_F"];
};
...
if (_opposingArmies in [4,5]) then {
	...
	INS_Op4_stat_weps = ["O_HMG_01_high_F","O_GMG_01_high_F","O_G_Mortar_01_F","B_T_HMG_01_F","O_static_AT_F","O_GMG_01_F"];
...
if (_opposingArmies in [6,7]) then {
	...
	INS_Op4_stat_weps = ["I_E_HMG_01_high_F","I_E_GMG_01_high_F","I_E_Mortar_01_F","I_E_HMG_01_F","I_E_HMG_01_A_F","I_E_GMG_01_F","I_E_GMG_01_A_F","I_E_Static_AT_F"];
...
private _gridMarkerUnitPools = {
	...
	switch (_faction) do {
		case 0: {// EAST RHS AFRF FACTION VERSION 1er-RPIMA
			_InfPool=	["rhs_vmf_emr_marksman","rhs_vmf_emr_aa","rhs_vmf_emr_engineer","rhs_vmf_emr_medic","rhs_vmf_emr_machinegunner","rhs_vmf_emr_strelok_rpg_assist","rhs_vmf_emr_grenadier_rpg","rhs_vmf_emr_RShG2","rhs_vmf_emr_LAT","rhs_vmf_emr_grenadier","rhs_vmf_emr_arifleman_rpk","rhs_vmf_emr_junior_sergeant"];
			_ArmPool=	["rhs_bmd4ma_vdv","rhs_bmd1r","rhs_bmd2m","rhs_bmp2d_vdv","rhs_bmp3_late_msv","rhs_t72bd_tv","rhs_t72be_tv","rhs_t80uk","rhs_t90sab_tv"];
			_MotPool=	["rhs_btr80_msv","rhs_btr80a_msv","rhs_kamaz5350_msv","rhs_kamaz5350_open_msv","RHS_Ural_MSV_01","RHS_Ural_Open_MSV_01","RHS_Ural_Zu23_MSV_01"];
			_ACHPool=	["RHS_Mi8MTV3_heavy_vdv","RHS_Ka52_vvsc","RHS_Mi24V_vdv"];
			_CHPool=	["rhs_ka60_grey","RHS_Mi8mt_vdv","RHS_Mi8MTV3_vdv"];//"O_Heli_Transport_04_bench_F"
			_uavPool=	[];
			_stPool=	["rhs_Igla_AA_pod_vdv","rhs_KORD_high_VDV","RHS_ZU23_VDV","rhs_2b14_82mm_vdv","rhs_D30_at_vdv","rhs_D30_vdv"];
			_shipPool=	["O_Boat_Armed_01_hmg_F","O_Boat_Transport_01_F"];
			_diverPool=	["O_diver_exp_F","O_diver_F","O_diver_TL_F"];
			_crewPool=	["rhs_vmf_flora_armoredcrew","rhs_vmf_emr_marksman","rhs_vmf_emr_aa","rhs_vmf_emr_engineer","rhs_vmf_emr_medic","rhs_vmf_emr_machinegunner","rhs_vmf_emr_strelok_rpg_assist","rhs_vmf_emr_grenadier_rpg","rhs_vmf_emr_RShG2","rhs_vmf_emr_LAT","rhs_vmf_emr_grenadier","rhs_vmf_emr_arifleman_rpk","rhs_vmf_emr_junior_sergeant"];
			_heliCrew=	["rhs_pilot_combat_heli"];
			_issueNVG= false;// true if faction can have NVGs else false
		};
		case 1: {// INDEPENDENT AAF FACTION
			_InfPool=	["DSF_AFMIL_Marksman","DSF_AFMIL_AASoldier","DSF_AFMIL_RPG7Soldier","DSF_AFMIL_ATSoldier","DSF_AFMIL_AutomaticRifleman","DSF_AFMIL_TeamLeader","DSF_AFMIL_SquadLeader","DSF_AFMIL_Explosives","DSF_AFMIL_Rifleman","DSF_AFMIL_Rifleman_Lite","DSF_AFMIL_Grenadier","DSF_AFMIL_RPG7Grenadier","DSF_AFMIL_Medic","DSF_AFMIL_MachineGunner","DSF_AFMIL_Officer","DSF_AFMIL_Repair"];
			_ArmPool=	["ARM_I_LT_01_AT_F","ARM_I_LT_01_cannon_F","ARM_I_LT_01_scout_F","ARM_I_LT_01_AA_F","yo_pandur_guerilla_02","yo_pandur_guerilla_03"];
			_MotPool=	["I_C_Offroad_02_AT_F","I_C_Offroad_02_LMG_F","C_Truck_02_covered_F"];//"I_MRAP_03_F"
			_ACHPool=	["ARM_O_Heli_Light_02_dynamicLoadout_F"];
			_CHPool=	["I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F"];
			_uavPool=	["I_UAV_01_F","I_UAV_02_CAS_F","I_UGV_01_rcws_F"];
			_stPool=	["I_Mortar_01_F","I_GMG_01_high_F","I_HMG_01_high_F","I_static_AT_F"];
			_shipPool=	["I_Boat_Transport_01_F","I_Boat_Armed_01_minigun_F"];
			_diverPool=	["I_diver_exp_F","I_diver_F","I_diver_TL_F"];
			_crewPool=	["DSF_AFMIL_Crewman"];
			_heliCrew=	["DSF_AFMIL_Crewman"];
			_issueNVG= false;
		};
		case 2: {// INDEPENDENT FIA FACTION
			_InfPool=	["ARM_rifleman_1","ARM_rifleman_2","ARM_rifleman_3","ARM_rifleman_4","ARM_rifleman_5","ARM_rifleman_6","ARM_Grenadier","ARM_SL","ARM_TL","ARM_riflemanAT_rpg7","ARM_Marksman","ARM_Medic"];
			_ArmPool=	[];
			_MotPool=	["I_C_Offroad_02_LMG_F","I_C_Offroad_02_AT_F"];
			_ACHPool=	["ARM_O_Heli_Light_02_dynamicLoadout_F"];
			_CHPool=	["O_Heli_Transport_04_covered_F"];
			_uavPool=	[];
			_stPool=	["ARM_Mortar_01_F","ARM_HMG_02_F"];
			_shipPool=	["ARM_Boat_F"];
			_diverPool=	["I_diver_exp_F","I_diver_F","I_diver_TL_F"];
			_crewPool=	["ARM_rifleman_1"];
			_heliCrew=	["ARM_SL","ARM_rifleman_1","ARM_Autorifleman","ARM_Medic","ARM_riflemanAT_rpg7","ARM_Grenadier"];
			_issueNVG= false;
		};
		...
		case 6: {//EAST Spetsnaz
			_InfPool=	["O_R_recon_LAT_F","O_R_recon_TL_F","O_R_recon_exp_F","O_R_recon_AR_F","O_R_recon_GL_F","O_R_recon_medic_F","O_R_recon_JTAC_F","O_R_recon_M_F","O_R_recon_medic_F","O_R_recon_JTAC_F","O_R_recon_M_F"];
			_ArmPool=	[];
			_MotPool=	["rhs_tigr_vdv","rhs_tigr_sts_vdv","rhs_tigr_m_vdv"];
			_ACHPool=	[];
			_CHPool=	["rhs_ka60_grey","RHS_Mi8mt_vdv","RHS_Mi8MTV3_vdv","RHS_Mi8amt_civilian","RHS_Mi8t_civilian"];
			_uavPool=	["O_UAV_01_F","O_UAV_02_CAS_F","O_UGV_01_rcws_F"];
			_stPool=	[];
			_shipPool=	["O_Boat_Transport_01_F","O_T_Boat_Armed_01_hmg_F"];
			_diverPool=	["O_diver_exp_F","O_diver_F","O_diver_TL_F"];
			_crewPool=	["O_R_Patrol_Soldier_Engineer_F"];
			_heliCrew=	["rhs_pilot_combat_heli"];
			_issueNVG= true;
		};
...
switch (_opposingArmies) do {
	// RHS AFRF and Spetsnaz (@RHSAFRF)
	case 1: {_enemyFactions = [0,6]};
	// AAF (no mods)
