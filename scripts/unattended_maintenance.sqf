...
sleep 20;
*/
{_x setDamage 0;} forEach (allMissionObjects "I_Heli_Transport_02_F"),(allMissionObjects "maestro_B_T_UAV_03_dynamicLoadout_F"), (allMissionObjects "I_Heli_light_03_dynamicLoadout_F");// Work around for new bug since A3 1.78 - these helis incur damage at mission start and after recreated... wtf 
