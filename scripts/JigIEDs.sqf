...
IEDtypes = [/*"IEDLandBig_F","IEDLandSmall_F","IEDUrbanBig_F","IEDUrbanSmall_F"*/"ACE_IEDUrbanSmall_Range","ACE_IEDLandSmall_Range","ACE_IEDUrbanBig_Range","ACE_IEDLandBig_Range","IEDUrbanBig_F","IEDUrbanSmall_F"];
