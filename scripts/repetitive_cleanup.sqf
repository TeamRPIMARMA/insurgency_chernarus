...
private _ttdBodies           = 120*60; // seconds to delete dead bodies
private _ttdVehiclesDead     = 120*60; // seconds to delete dead vehicles // <- mostly redundant because destroyed vehicles are managed by killed eventhandlers in BMR Insurgency
private _ttdVehiclesImmobile = 0;    // immobile vehicles // <- not needed
private _ttdWeapons          = 120*60; // seconds to delete dropped weapons
private _ttdPlanted          = 0;    // planted explosives - interferes with minefield task if set above 0
private _ttdSmokes           = 120*60; // seconds to delete dropped smokes/chemlights
private _ttdCraters          = 120*60; // seconds to delete craters
private _ttdJetParts         = 120*60; // seconds to delete canopies,ejection seats
